...
class MobileDetect {
	...
	function isMobile($mobileredirect=false,$desktopredirect=false,$iphone=true,$ipad=true,$android=true,$opera=true,$blackberry=true,$palm=true,$windows=true){
	  ...
	  switch(true){ // using a switch against the following statements which could return true is more efficient than the previous method of using if statements
		...
		case (preg_match('/opera mini|opera mobi/i',$user_agent)); // we find opera mini in the user agent
